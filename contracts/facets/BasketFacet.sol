...
import "../access/CallProtection.sol";
import "../access/ReentryProtection.sol";
...
//    uint256 public constant MAX_ANNUAL_FEE = 10**17; // 10%
    ...
    // Assuming a block gas limit of 12M this allows for a gas consumption per token of roughly 333k allowing 2M of overhead for additional operations
